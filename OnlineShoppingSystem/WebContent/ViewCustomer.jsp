...
<table id="customers">
	...
	<tr>
		...
		<th>Zipcode</th> -->
          ...
          List<Customer> get=c.retrieveCustomerDatas();
          CustomerServiceImp cp =new CustomerServiceImp();
          List<Address> list1=cp.retrieveAddressDatas();
          ...
          {%>
    		...
    		<tr>    	
        	<td><%out.println(re.getCustomer_Id());%></td>
    		<td><%out.println(re.getCustomer_First_Name());%></td>
    		<td><%out.println(re.getCustomer_Last_Name());%></td>
        	<td><%out.println(re.getCustomer_Gender());%></td>
        	<td><%out.println(re.getCustomer_DOB());%></td>
        	<td><%out.println(re.getCustomer_Contact());%></td>
    		<td><%out.println(re.getCustomer_Email());%></td>
    		<td><%out.println(re.getCustomer_Register_Date());%></td>
    		<%-- <td><%out.println(re.getcustomer_Address_Id());%></td> --%>
			<% 
			for(Address add:list1){
			 if(re.getcustomer_Address_Id()==add.getAddress_Id()) 
				{%>
				<td><%out.println(add.getAddress());%></td>
				<td><%out.println(add.getCity());%></td>
				<td><%out.println(add.getState());%></td>
				<td><%out.println(add.getCountry());%></td>
				<td><%out.println(add.getZipcode());%></td>
