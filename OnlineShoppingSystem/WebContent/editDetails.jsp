...
<div class="product-information">
							...
							<form action="EditProductController" method="post">
								<h2><input type="text" name="pdtname" value="<%= ps.getProduct_Name() %>"></h2>
								...
								<p>Product ID:
								<input type="text" readonly name="pdtid" value="<%= ps.getProduct_Id()%>">*</p> 
								<p>Description:
								<input type="text" name="description" value="<%= ps.getDesc()%>"></p>
								<p>Price:
								<input type="text" name="price" value="<%= ps.getPrice()%>"></p>
								<span>
