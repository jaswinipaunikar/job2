...
<head>
    ...
    <title>Add Category | Shoptos</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--add category form-->
						<h2>Add Category</h2>
						<form action="AddCategoryController" method="post">
							<input type="text" name="catname" placeholder="Category name"  pattern="(*[A-Za-z])" title="please enter valid category" maxlength="100" required/>
							<textarea name="catdesc" placeholder="Description" rows="10" cols="30"   pattern ="(*[A-Za-z])" title="please enter valid input " maxlengtht="1000" required ></textarea>
