...
<head>
    ...
    <title>Edit Supplier | E-Shoptos</title>
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="product-form"><!--add product form-->
						...
						<form action="EditSupplierController" method="post">
							<input type="text" name="supid" placeholder="Supplier ID" />
							<input type="text" name="supname" placeholder="Supplier Name" />
							<input type="text" name="supuser" placeholder="Supplier UserName" />
							<input type="text" name="suppass" placeholder="Supplier Password" />
							<input type="text" name="supcontact" placeholder="Supplier_Contact" />
							 <input type="text" name="supemail" placeholder="Supplier Email" /> 
							<p></>Address</p>
