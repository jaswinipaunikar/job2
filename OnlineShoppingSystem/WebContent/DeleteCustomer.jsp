...
admin page</h1>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 col-sm-offset-1">
				...
				<%     
	String cust_id = request.getParameter("x");
	Customer c=new Customer();
	CustomerServiceImp cts = new CustomerServiceImp();
	int cat = cts.deletes(cust_id);
 ...
 %>
					...
					<form action="DeleteCustomerController" method="post">
						...
						<input type="text" name="customerID" value=<%=cust_id %>/>
