...
<head>
    ...
    <title>Edit Category |Shoptos</title>
...
<body>
	...
	<%
		...
		cat=cs.catDetails(cat_Id);
	%>
	<section id="form"><!--form-->
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="product-form"><!--add category form-->
						<h2>Edit Category</h2>
						<form action="UpdateCategoryController" method="post">
						<input type="text"  readonly name="cId" value="<%= cat_Id%>"  required pattern="(\d*[0-9])"  title="please enter valid ID" maxlength="5" required />
							<input type="text" name="catname" placeholder="Category name"  required pattern="(*[A-Za-z])" title="please enter valid name" maxlength="100" required />
							<textarea name="catdesc" placeholder="Description" rows="10" cols="30"  required pattern ="(.=/,*[A-Za-z])" title="please enter valid input " maxlengtht="1000" required ></textarea>
