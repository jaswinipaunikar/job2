...
<head>
    ...
    <title>Delete Employee | Shoptos</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="product-form"><!--delete employee form-->
						<h2>Delete Employee</h2>
						<form name="myform" action="EmployeeDeleteController" method="post" > 
					
							ENTER THE EMPLOYEE ID :<input type="text" name="empid" required pattern="\d*[0-9]" maxlength="5" required="required" placeholder="100" />
							
							<button type="submit" value="Delete" class="btn btn-default">
							Delete</button>
						</form>
					</div><!--/delete employee form-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>Have the best shopping experience at Shoptos...Make your home as your dream home</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
