...
<head>
    ...
    <title>Customer Home | Shoptos</title>
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Category<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="ViewCatCust.jsp">View Category</a></li> 
										   </ul>
                                </li>
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian">category-productsr
							<div class="panel panel-default">
								...
								<div id="Kitchen Accessories" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#">Plate stand </a></li>
											<li><a href="#">Glasses </a></li>
											<li><a href="#">Spoon stand </a></li>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#Bathroom Accessories">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
...
<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright Â© 2017 Shoptos. All rights reserved.</p>
					<p class="pull-right">Designed by Shoptos</p>
				</div>
			</div>
		</div>
