...
<head>
    ...
    <title>Edit Customer | Shoptos</title>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Category<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="viewCategory.jsp">Kitchen </a></li>
										<li><a href="viewCategory.jsp">Bathroom</a></li>
									</ul>
                                </li>
...
<%
String id=request.getParameter("custUserName1");/* 
String id = (String)session.getAttribute("custUserName1"); */
