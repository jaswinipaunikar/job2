...
<head>
    ...
    <title>Add Customer | Shoptos</title>
...
<section>
<form action="AddCustomerByAdmin" method="post">
	<div class="container">
		<div class="row">
			<h1>add customer</h1>
			<table id="customers">
	...
	<tr>
        ...
        for(Customer re:get)
        {
        	...
        	out.println("<tr>");
    		out.println("<td>");
    		out.println(re.getCustomer_Id());
    		%>
    		<input type="hidden" name="customerID" value="<%=re.getCustomer_Id()%>">	
    		<% out.println("</td>");
    		out.println("<td>");
    		out.println(re.getCustomer_First_Name());
    		out.println("</td>");
    		out.println("<td>");
    		out.println(re.getCustomer_Last_Name());
    		out.println("</td>");
    		out.println("<td>");
    		out.println(re.getCustomer_Gender());
    		out.println("</td>");
    		out.println("<td>");
    		out.println(re.getCustomer_DOB()); 
            out.println("</td>");
    		out.println("<td>");
    		out.println(re.getCustomer_Contact()); 
            out.println("</td>");
            out.println("<td>");
    		out.println(re.getCustomer_Email());
            out.println("</td>");
            out.println("<td>");
    		out.println(re.getCustomer_Register_Date()); 
            out.println("</td>");
            out.println("<td>");
    		out.println(re.getCustomer_Status()); 
            out.println("</td>");
            %>
            <td>
